<script setup lang="ts">
    ...
    const colors = computed(() => {
        switch (props.category) {
            ...
            case 'community':
                return [
                    { name: 'Facebook', var: '--color-facebook', hex: '#3b5998' },
                    { name: 'Linkedin', var: '--color-linkedin', hex: '#1366C0' },
            ...
            case 'mdtag':
                return [
                    ...
                    { name: 'vue', var: '--color-mdtag-vue', hex: '#41B883' }
                ];
            default:
                return [];
        }
